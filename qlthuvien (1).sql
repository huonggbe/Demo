...
-- Thời gian đã tạo: Th8 28, 2024 lúc 09:18 AM
-- Phiên bản máy phục vụ: 8.0.39-0ubuntu0.24.04.2
-- Phiên bản PHP: 8.3.6
...
CREATE TABLE `loaitailieu` (
  ...
  `TenLoaiTaiLieu` varchar(70) COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `muonsach` (
  ...
  `NguoiChoMuon` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `NgayMuon` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `NgayTra` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `ViPham` varchar(255) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `HinhThucXuLy` varchar(255) COLLATE utf8mb3_unicode_ci DEFAULT 'Giá trị mặc định',
  `TrangThai` varchar(255) COLLATE utf8mb3_unicode_ci DEFAULT '2'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci ROW_FORMAT=DYNAMIC;
...
(129, 78, '2024-08-28 14:31:58', NULL, '2024-08-28', '2024-09-04', NULL, 'Giá trị mặc định', '2');

--
-- Bẫy `muonsach`
--
DELIMITER $$
CREATE TRIGGER `before_insert_muonsach` BEFORE INSERT ON `muonsach` FOR EACH ROW BEGIN
    IF NEW.NgayMuon IS NULL THEN
        SET NEW.NgayMuon = CURDATE()$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `before_insert_muonsach1` BEFORE INSERT ON `muonsach` FOR EACH ROW BEGIN
    IF NEW.NgayMuon IS NOT NULL THEN
        SET NEW.NgayTra = DATE_ADD(NEW.NgayMuon, INTERVAL 7 DAY)$$
DELIMITER ;
...
CREATE TABLE `tailieu` (
  ...
  `MaLSP` int NOT NULL,
  `MaDM` int NOT NULL,
  `TenTL` varchar(255) COLLATE utf8mb3_unicode_ci NOT NULL,
  ...
  `TacGia` varchar(50) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `NhaXuatBan` varchar(50) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `SoTrang` varchar(50) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `NgonNgu` varchar(50) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `TrangThai` int NOT NULL,
...
--
ALTER TABLE `loaitailieu`
  MODIFY `MaTaiLieu` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;

--
-- AUTO_INCREMENT cho bảng `muonsach`
--
ALTER TABLE `muonsach`
  MODIFY `MaHD` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=130;

--
-- AUTO_INCREMENT cho bảng `nguoidung`
--
ALTER TABLE `nguoidung`
  MODIFY `MaND` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=84;

--
-- AUTO_INCREMENT cho bảng `phanquyen`
--
ALTER TABLE `phanquyen`
  MODIFY `MaQuyen` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT cho bảng `tailieu`
--
ALTER TABLE `tailieu`
  MODIFY `MaSP` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=188;
